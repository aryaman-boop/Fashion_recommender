...
Original file is located at
    https://colab.research.google.com/drive/11dcq4CWZ8uAt1kTlChToXJK5Baam5w7Y
"""
    ...
    def __getitem__(self, index):
        try:
            if self.mode == 'relative':
                ...
                if self.split == 'train':
                    reference_image_path = base_path / 'images' /'images'/ f"{reference_name}.png"
                    reference_image = self.preprocess(PIL.Image.open(reference_image_path))
                    target_name = self.triplets[index]['target']
                    target_image_path = base_path / 'images' /'images'/ f"{target_name}.png"
                ...
                image_path = base_path / 'images' /'images'/ f"{image_name}.png"
